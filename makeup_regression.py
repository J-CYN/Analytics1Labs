...
print(f"{model_with.coef_[0]:.4f}")
print(f"{model_without.coef_[0]:.4f}")
...
numeric_features = df.select_dtypes(include=[np.number])  # Exclude the target variable itself   
